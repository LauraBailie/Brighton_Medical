...
namespace _43938442_Exam_WebApp {
    ...
    public partial class PatientDataSet : global::System.Data.DataSet {
        ...
        public partial class PatientsDataTable : global::System.Data.TypedTableBase<PatientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PatientsRow AddPatientsRow(int ID, string FirstName, string LastName, string Cell, string Email, string Allergies, string EmergencyContact, string Password) {
...
namespace _43938442_Exam_WebApp.PatientDataSetTableAdapters {
    ...
    public partial class PatientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Patients] ([ID], [FirstName], [LastName], [Cell], [Email], [Allergies], [EmergencyContact], [Password]) VALUES (@ID, @FirstName, @LastName, @Cell, @Email, @Allergies, @EmergencyContact, @Password);
SELECT ID, FirstName, LastName, Cell, Email, Allergies, EmergencyContact, Password FROM Patients WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patients] SET [ID] = @ID, [FirstName] = @FirstName, [LastName] = @LastName, [Cell] = @Cell, [Email] = @Email, [Allergies] = @Allergies, [EmergencyContact] = @EmergencyContact, [Password] = @Password WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Cell = 1 AND [Cell] IS NULL) OR ([Cell] = @Original_Cell)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_EmergencyContact = 1 AND [EmergencyContact] IS NULL) OR ([EmergencyContact] = @Original_EmergencyContact)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT ID, FirstName, LastName, Cell, Email, Allergies, EmergencyContact, Password FROM Patients WHERE (ID = @ID)";
        ...
        public virtual int Delete(int Original_ID, string Original_FirstName, string Original_LastName, string Original_Cell, string Original_Email, string Original_EmergencyContact, string Original_Password) {
        ...
        public virtual int Insert(int ID, string FirstName, string LastName, string Cell, string Email, string Allergies, string EmergencyContact, string Password) {
        ...
        public virtual int Update(int ID, string FirstName, string LastName, string Cell, string Email, string Allergies, string EmergencyContact, string Password, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Cell, string Original_Email, string Original_EmergencyContact, string Original_Password) {
            ...
            if ((Original_Cell == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_Cell));
            }
            if ((Original_Email == null)) {
            ...
            if ((Original_EmergencyContact == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_EmergencyContact));
            }
            if ((Original_Password == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Cell, string Email, string Allergies, string EmergencyContact, string Password, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Cell, string Original_Email, string Original_EmergencyContact, string Original_Password) {
            return this.Update(Original_ID, FirstName, LastName, Cell, Email, Allergies, EmergencyContact, Password, Original_ID, Original_FirstName, Original_LastName, Original_Cell, Original_Email, Original_EmergencyContact, Original_Password);
        }
    }
