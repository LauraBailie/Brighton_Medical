...
namespace _43938442_ExamProject.PatientDataSet2TableAdapters {
...
SELECT ID, FirstName, LastName, Cell, Email, Allergies, EmergencyContact, Password, Doctor, Date, Time, AppointmentType, Status, Amount FROM Patients WHERE (ID = @ID)";
        ...
        public virtual int Fill(PatientDataSet2.PatientsDataTable dataTable) {
        ...
        public virtual PatientDataSet2.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PatientDataSet2.PatientsDataTable dataTable = new PatientDataSet2.PatientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PatientDataSet2.PatientsDataTable dataTable) {
